    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weather', models.IntegerField(blank=True, choices=[(0, 'No effect'), (1, 'Possible effect'), (2, 'Definite effect')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fpc', models.FloatField(blank=True, default=0, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ang_fn', models.CharField(choices=[('agnvis', 'ANGVIS'), ('angorig', 'ANGORIG'), ('angmeth', 'ANGMETH'), ('angguid', 'ANGGUID'), ('angop1', 'ANGOP1'), ('angop2', 'ANGOP2'), ('angop3', 'ANGOP3'), ('angop4', 'ANGOP4'), ('angop5', 'ANGOP5')], max_length=2)),
                ('ang_val', models.CharField(blank=True, max_length=4, null=True)),
                ('ang_freq', models.IntegerField()),
                ('ang_prop', models.FloatField()),
                ('pty_freq', models.IntegerField()),
                ('pty_prop', models.FloatField()),
                ('fr712', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='angler_options', to='creel_portal.FR712')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='fr712',
            name='stratum',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='strata_values', to='creel_portal.Strata'),
        ),
        migrations.CreateModel(
            name='FN125_Lamprey',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fr712', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='catch_estimates', to='creel_portal.FR712')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fr712', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='effort_estimates', to='creel_portal.FR712')),
            ],
            options={
